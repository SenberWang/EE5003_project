...
sClstOutputPkg Cluster_1(volatile ap_int<32> *ddr_0, struct sClstInputPkg *ClstInputPkg, struct sSpikeMemPkg *SpikeMemPkg, struct sOutputMemPkg OutputMemPkg,int weight_base_addr);
