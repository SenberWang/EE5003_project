...
sClstOutputPkg Cluster_0(volatile ap_int<32> *ddr_0,
...
void RunCluster_0(ap_uint<4> ClusterID, volatile ap_int<32> *ddr_0, struct sClstInputPkg *ClstInputPkg, struct sSpikeMemPkg *SpikeMemPkg, struct sOutputMemPkg *OutputMemPkg, _reg_timestep GlobalTimeStep, struct sClstOutputPkg *ClstOutputPkg,int weight_base_addr)
{
	...
	*((ClstInputPkg+ClusterID)->TimeStep) = GlobalTimeStep;
	...
	ClstOutputPkg[ClusterID] = Cluster_0(ddr_0, ClstInputPkg+ClusterID, SpikeMemPkg, OutputMemPkg+ClusterID,weight_base_addr);
}