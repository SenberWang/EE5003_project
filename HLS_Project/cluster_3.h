#ifndef _CLS3_HEADER_
#define _CLS3_HEADER_
...
sClstOutputPkg Cluster_3(volatile ap_int<32> *ddr_0, struct sClstInputPkg *ClstInputPkg, struct sSpikeMemPkg *SpikeMemPkg, struct sOutputMemPkg OutputMemPkg,int weight_base_addr);
